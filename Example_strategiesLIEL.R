...
example_params <- list(
                    ...
                    "Williams%r&MovingAverage" = list(lookback = 35,williamsLookback =1,series = 1:10,posSizes = rep(1, 10),overboughtThreshold = -20,oversoldThreshold = -80)
                     )
